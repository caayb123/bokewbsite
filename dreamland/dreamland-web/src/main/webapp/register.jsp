...
<head>
	<meta charset="UTF-8">
	<title>注册页面</title>
	<meta name="keywords" content="博客网">
	<meta name="content" content="博客网">
...
<div class="zhuce_body" >
    <div class="zhuce_kong" id="dre_div">
    	<div class="zc">
            ...
            <h3>欢迎注册</h3>
       	  	  <form action="${ctx}/check/regist" method="post" id="registerForm">
                ...
                <div>
               		<input id="protocol" type="checkbox" onclick="checkProtocol();"><span>已阅读并同意<a href="#" target="_blank" ><span class="lan">《博客网用户协议》</span></a></span>
                    <br/>
        	...
        	<div id="regist-right" class="bj_right" style="height: 468px">
                <br>
                <p>已有账号？ <a href="${ctx}/login.jsp" class="zhuce_qq">立即登录</a></p>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $("#to_register").click (function(){
        if(!checkProtocol()){
            $("#protocol_span").text("请勾选\"阅读并接受博客网用户协议\"！").css("color","red");
        }else{
            $("#protocol_span").text("");
        }

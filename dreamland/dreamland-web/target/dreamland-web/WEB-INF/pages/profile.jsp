...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-example">
            ...
            <ul class="nav navbar-nav">
                <li><a href="${ctx}/jump/writedream?id=${user.id}">写博客</a></li>
            </ul>
...
<div style="margin-left: 100px;margin-top: 80px;" class="main-content">
    ...
    <div style="width: 800px;height: 600px;background-color: white;float: left;">
        ...
        <div id="base_content" style="margin-top: 40px;margin-left: 60px;font-size: 18px;" >
            ...
            <div>
                <form id="userInfo_form" action="${ctx}/personal/saveUserInfo" method="post">

                    姓名：<input id="name" name="name" value="${userInfo.name}"/><br/><br/>

                    昵称：<input id="nick_name" name="nickName" value="${user.nickName}"/><br/><br/>
                    ...
                    生日： <input  style="width: 198px;float: right;margin-right: 484px;margin-top: -4px" class="form-control form-date"  readonly="readonly" placeholder="选择一个日期：yyyy-MM-dd" type="text" id="txtEndDate"  name="birthdayy" value="${userInfo.formateBirthday==null?"":userInfo.formateBirthday}"/><br/><br/>
        ...
        <div id="account_content" style="margin-top: 40px;margin-left: 60px;font-size: 18px;display: none" >
            ...
            <div>
                <form>
                账号：${user.email}<br/><br/>
                    密码：******  <a href="${ctx}/personal/repassword"><span id="password_span" style="color: grey;margin-left: 142px" onmouseover="changeColor(this);" onmouseout="backColor(this);" >修改</span></a><br/><br/>
                    <c:if test="${not empty user.phone}">
                        手机号：<a href="${ctx}/personal/cell">${user.phone.substring(0,3)}****${user.phone.substring(7,11)}  <span id="phone_span" style="color: grey;margin-left: 68px" onmouseover="changeColor(this);" onmouseout="backColor(this);">修改</span></a>
                    </c:if>

                    ...
                    <form id="normal_form" name="form" role="form" class="login-form" action="${ctx}/login/doLogin" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox">
                                <label>
                                    <br/>
                                     <c:if test="${error eq 'feng'}">
                                         <span style="color: red" id="back_feng">您的账号已被管理员封号</span>
                                     </c:if>
                        ...
                        <div class="form-group">
                            ...
                            <br/>
                            <div style="margin-left: 260px"> <a href = "${ctx}/register.jsp" >立即注册</a></div>
                        </div>
                    </form>
                </div>
                <!--手机登录-->
...
<script>
    ...
    $(function () {
        ...
        if(msg == "fenghao"){
            ...
            $("#account-login").attr("class","tab-pane fade");
            $("#a_login").attr("class","");
            $("#phone_span").text("账号已被管理员封号").css("color","red");
        }
    });
    //校验用户名
